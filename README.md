...
- [プロジェクト２](https://github.com/mafu-opening-theory/Shogi_opening_theory/releases/tag/v2.0)

ファイル名が長すぎたのか、文字化けのようになっていますが、.depth.x.7zが全体型（depth３×３億局面）再学習です。特化型は出来次第ＵＰします。
