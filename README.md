## 現在検証してほしい評価関数「mafuzero」[※対局結果求む](https://github.com/mafu-opening-theory/Shogi_opening_theory/releases/tag/v5.0)
- 手持ち最高レートを「ＲＥＭＵ」で解析し、似ている特長を抽出した評価関数「mafuzero」を添付した。
