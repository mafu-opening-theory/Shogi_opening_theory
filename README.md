...
- [プロジェクト３](https://github.com/mafu-opening-theory/Shogi_opening_theory/releases/tag/3.0)学習用定跡作成プロジェクト２の結果より効率的に学習出来るかもしれない、「学習用定跡」（教師局面生成用）をいくつか作成、配布してみます。※現在作成中
